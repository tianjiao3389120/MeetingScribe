...
enum Entry {
    static func main() {
        // Initialise the selected data environment before either the GUI or a
        // Finder-opened/headless file starts touching stores and preferences.
        AppEnvironment.prepareForLaunch()
