...
enum TranscriptCache {
    ...
    static let diarizationVersion = "diarization-v6|pyannote-int8|campplus|threshold0.72|min0.5-0.6|clean-reference-segments1"

    private static let directory: URL = {
        let base = AppEnvironment.cacheDirectory
