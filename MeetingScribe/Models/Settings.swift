...
final class Settings {
    ...
    var pipelineDebugPauseAtNodeStart: Bool {
        didSet { defaults.set(pipelineDebugPauseAtNodeStart, forKey: Keys.pipelineDebugPauseAtNodeStart) }
    }
    ...
    private enum Keys {
        ...
        static let pipelineDebugPauseAtNodeStart = "pipelineDebugPauseAtNodeStart"
    ...
    private init() {
        ...
        pipelineDebugPauseAtNodeStart = defaults.object(
            forKey: Keys.pipelineDebugPauseAtNodeStart) as? Bool ?? false
