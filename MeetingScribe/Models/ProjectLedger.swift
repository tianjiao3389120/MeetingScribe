...
struct ProjectIssue: Codable, Identifiable, Sendable, Equatable {
    ...
    /// User-controlled priority marker. Optional storage keeps older ledgers compatible
    /// and preserves when the issue was marked without changing its business update time.
...
struct ProjectIssueAnalysis: Codable, Identifiable, Sendable, Equatable {
    /// Increment whenever the analysis contract or evidence interpretation changes in a
    /// way that requires a full rebuild instead of an event-only incremental update.
    static let currentAnalyzerVersion = 7
    ...
    struct TimelineItem: Codable, Identifiable, Sendable, Equatable {
        ...
        var meetingTitle: String
        var change: String
        /// Optional richer fields added by the issue-profile v3 analyzer. Keeping them
        /// optional lets previously saved v2 analyses continue to decode and display.
    ...
    var markdown: String?
    var analyzerVersion: Int? = nil
    /// Structured profile fields added by issue-profile v4. Optional fields keep all
    /// analyses generated by earlier versions readable without migration.
    /// User-facing cause-process-result narrative added by issue-profile v5.
    var overview: String? = nil
    var stableConclusion: String? = nil
    var latestProgress: String? = nil
    var unresolvedItems: [String]? = nil
    var nextSteps: [String]? = nil
    var diagnosticGuardrails: [String]? = nil
    var conclusionChangeReason: String? = nil
    ...
    func needsAnalysisRefresh(comparedWith issue: ProjectIssue) -> Bool {
        isStale(comparedWith: issue)
    ...
    init(issueID: String, workspaceID: UUID, summary: String,
         ...
         unresolvedItems: [String]? = nil, nextSteps: [String]? = nil,
         diagnosticGuardrails: [String]? = nil,
        ...
        self.stableConclusion = stableConclusion
